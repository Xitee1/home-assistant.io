...
- `sensor.qbittorrent_upload_speed_limit`: The active qBittorrent upload speed limit.
- `sensor.qbittorrent_download_speed_limit`: The active qBittorrent download speed limit.
